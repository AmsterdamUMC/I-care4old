...
outcome = 'SCPS_ltc_decline_target'
...
#%%
# Data-driven confounder selection
...
y_train_all = X_orig_train['SCPS_ltc_decline_target'].astype(float)
x_train_all = X_orig_train
y_test = X_orig_test['SCPS_ltc_decline_target'].astype(float)
x_test = X_orig_test

# Normalized data
#y_train_all = X_train['SCPS_ltc_decline_target'].astype(float)
#x_train_all = X_train
#y_test = X_test['SCPS_ltc_decline_target'].astype(float)
#x_test = X_test
...
file_name = '/data/hyperparameters_antipsychotics_disc_cps_decline'
...
plt.ylabel('ADL decline', fontsize=14)
