...
y_train_all = X_orig_train['ABS_decline_target'].astype(float)
x_train_all = X_orig_train
y_test = X_orig_test['ABS_decline_target'].astype(float)
x_test = X_orig_test

# Normalized data
#y_train_all = X_train['ABS_decline_target'].astype(float)
#x_train_all = X_train
#y_test = X_test['ABS_decline_target'].astype(float)
#x_test = X_test
...
file_name = '/data/hyperparameters_antipsychotics_disc_abs_decline'
