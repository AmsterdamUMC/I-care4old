...
outcome = 'SADLH_ltc_decline_target'
...
y_train_all = X_orig_train['SADLH_ltc_decline_target'].astype(float)
x_train_all = X_orig_train
y_test = X_orig_test['SADLH_ltc_decline_target'].astype(float)
x_test = X_orig_test

# Normalized data
#y_train_all = X_train['SADLH_ltc_decline_target'].astype(float)
#x_train_all = X_train
#y_test = X_test['SADLH_ltc_decline_target'].astype(float)
#x_test = X_test
...
file_name = '/data/hyperparameters_antipsychotics_disc_adl_decline'
