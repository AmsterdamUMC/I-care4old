...
outcome = 'CPS_decline_target' # unsteady gait
...
'CPS3', #		
'Pain scale', # 		
'Number of drugs', #	0.03	0.611
'Pain medications', #	0.005	0.584
'Analgesics', #	0.003	0.585
'psychotropic medications', #	0.024	0.552
'Number of comorbidities', #	0.035	0.581
'ADLH4', #		
'DRS3', #	0.02	0.565
'Age', #	0.04	0.513
'Reduced social interaction', #	0.035	0.51
'Change in social activities', #		
'Any neurological diagnosis', #		
'Any psychiatric diagnosis', #	0.03	0.514
'ABS', #		
]
...
y_train_all = X_orig_train['CPS_decline_target'].astype(float)
x_train_all = X_orig_train
y_test = X_orig_test['CPS_decline_target'].astype(float)
x_test = X_orig_test

# Normalized data
#y_train_all = X_train['CPS_decline_target'].astype(float)
#x_train_all = X_train
#y_test = X_test['CPS_decline_target'].astype(float)
#x_test = X_test
...
file_name = '/data/hyperparameters_anticholinergic_cps_decline'
